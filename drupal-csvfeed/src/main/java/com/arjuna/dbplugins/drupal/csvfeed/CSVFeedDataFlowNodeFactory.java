...
package com.arjuna.dbplugins.drupal.csvfeed;
...
import com.arjuna.dbplugins.drupal.csvfeed.dataflownodes.ProviderCSVFeedDataService;

public class CSVFeedDataFlowNodeFactory implements DataFlowNodeFactory
{
    public CSVFeedDataFlowNodeFactory(String name, Map<String, String> properties)
    {
        _name       = name;
        ...
        throws InvalidClassException, InvalidNameException, InvalidMetaPropertyException, MissingMetaPropertyException, InvalidPropertyException, MissingPropertyException
    {
        ...
        {
            if (metaProperties.isEmpty())
                return (T) new ProviderCSVFeedDataService(name, properties);
            else
                throw new InvalidMetaPropertyException("No metaproperties expected", null, null);
        }
        else
